...
export default function UploadBlog() {
  ...
  const handleCreateNews = (e) => {
    ...
    axios
      .post("https://api.homebaba.ae/api/news/", newsdata, {
        headers: {
  ...
  const handleUpdateNews = (e) => {
    ...
    axios
      .put(`https://api.homebaba.ae/api/news/${newsdata.id}/`, updatenewsdata, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      })
  ...
  function deleteNews(id) {
    axios
      .delete(`https://api.homebaba.ae/api/news/${id}/`)
      .then((res) => {
        setRefetcch(!refetch);
      })
      .catch((err) => {
  ...
  useEffect(() => {
    axios
      .get("https://api.homebaba.ae/api/news/")
      .then((res) => {
        setNews(res.data);
      })
      .catch((err) => {
  ...
  const handleEdit = (e, id) => {
    e.preventDefault();
    axios
      .get(`https://api.homebaba.ae/api/news/${id}/`)
      .then((res) => {
        setModalNews(true);
        setIsEdit(true);
